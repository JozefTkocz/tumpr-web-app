...
export namespace Athletes {
   ...
   * @secure
   * @response `200` `ActivityStats` Activity stats of the athlete.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetStats {
    ...
    export type ResponseBody = ActivityStats;
  }
   ...
   * @secure
   * @response `200` `(Route)[]` A representation of the route.
   * @response `default` `Fault` Unexpected error.
   */
...
export namespace Athlete {
   ...
   * @request GET:/athlete
   * @secure
   * @response `200` `DetailedAthlete` Profile information for the authenticated athlete.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetLoggedInAthlete {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedAthlete;
  }
   ...
   * @secure
   * @response `200` `Zones` Heart rate and power zones.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetLoggedInAthleteZones {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = Zones;
  }
   ...
   * @secure
   * @response `200` `(SummaryActivity)[]` The authenticated athlete's activities
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetLoggedInAthleteActivities {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = SummaryActivity[];
  }
   ...
   * @secure
   * @response `200` `(SummaryClub)[]` A list of summary club representations.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetLoggedInAthleteClubs {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = SummaryClub[];
  }
}
...
export namespace Segments {
   ...
   * @secure
   * @response `200` `DetailedSegment` Representation of a segment.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetSegmentById {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedSegment;
  }
   ...
   * @secure
   * @response `200` `(SummarySegment)[]` List of the authenticated athlete's starred segments.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetLoggedInAthleteStarredSegments {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = SummarySegment[];
  }
   ...
   * @secure
   * @response `200` `ExplorerResponse` List of matching segments.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace ExploreSegments {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ExplorerResponse;
  }
   ...
   * @secure
   * @response `200` `StreamSet` The set of requested streams.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetSegmentStreams {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = StreamSet;
  }
}
...
export namespace SegmentEfforts {
   ...
   * @secure
   * @response `200` `(DetailedSegmentEffort)[]` List of segment efforts.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetEffortsBySegmentId {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedSegmentEffort[];
  }
   ...
   * @secure
   * @response `200` `DetailedSegmentEffort` Representation of a segment effort.
   * @response `default` `Fault` Unexpected error.
   */
...
export namespace Activities {
   ...
   * @secure
   * @response `201` `DetailedActivity` The activity's detailed representation.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace CreateActivity {
    ...
    export type RequestHeaders = {};
    export type ResponseBody = DetailedActivity;
  }
   ...
   * @secure
   * @response `200` `DetailedActivity` The activity's detailed representation.
   * @response `default` `Fault` Unexpected error.
   */
  ...
  export namespace UpdateActivityById {
    ...
    export type RequestQuery = {};
    export type RequestBody = UpdatableActivity;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedActivity;
  }
   ...
   * @secure
   * @response `200` `(Lap)[]` Activity Laps.
   * @response `default` `Fault` Unexpected error.
   */
   ...
   * @secure
   * @response `200` `(ActivityZone)[]` Activity Zones.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetZonesByActivityId {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ActivityZone[];
  }
   ...
   * @secure
   * @response `200` `(SummaryAthlete)[]` Comments.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetKudoersByActivityId {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = SummaryAthlete[];
  }
...
export namespace Clubs {
   ...
   * @secure
   * @response `200` `DetailedClub` The detailed representation of a club.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetClubById {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedClub;
  }
   ...
   * @secure
   * @response `200` `(ClubAthlete)[]` A list of club athlete representations.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetClubMembersById {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ClubAthlete[];
  }
   ...
   * @secure
   * @response `200` `(SummaryAthlete)[]` A list of summary athlete representations.
   * @response `default` `Fault` Unexpected error.
   */
   ...
   * @secure
   * @response `200` `(ClubActivity)[]` A list of activities.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetClubActivitiesById {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ClubActivity[];
  }
}
...
export namespace Gear {
   ...
   * @request GET:/gear/{id}
   * @secure
   * @response `200` `DetailedGear` A representation of the gear.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetGearById {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DetailedGear;
  }
}
...
export namespace Routes {
   ...
   * @secure
   * @response `200` `File` A GPX file with the route.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetRouteAsGpx {
    export type RequestParams = {
      /**
       * The identifier of the route.
       * @format int64
   ...
   * @secure
   * @response `200` `File` A TCX file with the route.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetRouteAsTcx {
    export type RequestParams = {
      /**
       * The identifier of the route.
       * @format int64
   ...
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetRouteStreams {
    export type RequestParams = {
      /**
       * The identifier of the route.
       * @format int64
...
export namespace Uploads {
   ...
   * @secure
   * @response `201` `Upload` A representation of the created upload.
   * @response `default` `Fault` Unexpected error.
   */
   ...
   * @secure
   * @response `200` `Upload` Representation of the upload.
   * @response `default` `Fault` Unexpected error.
   */
  export namespace GetUploadById {
    export type RequestParams = {
      /**
